...
public class ListPosterUtils {
    ...
    public static void main(String[] args) {
        ...
        // 生成海报
        Map<String, Object> result = createListImage(basePath, appBrief);
     ...
     * @Param []
     **/
    public static Map<String, Object> createListImage(String basePath, AppBrief appBrief) {
