package com.coderdream.notebook.controller;

import com.coderdream.notebook.entity.Notebook;
import com.coderdream.notebook.repository.NotebookRepository;
...
public class NotebookController {
	...
	public String addNote(@Valid Notebook notebook, BindingResult result, Model model) {
		log.debug("add", model.toString());
		System.out.println("add " + model.toString());
		if (result.hasErrors()) {
			return "add-notebook";
		}
