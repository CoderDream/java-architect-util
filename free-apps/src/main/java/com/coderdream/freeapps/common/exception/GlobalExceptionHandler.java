package com.coderdream.freeapps.common.exception;
...
public class GlobalExceptionHandler {
    ...
    /**
     * 使用@Validated 来校验 JavaBean的参数，比如@NotNull、@NotBlank等等; post
     * 请求数据传递有两种方式，一种是基于form-data格式的数据传递，这种传递才会抛出BindException异常
     *
     * @param e
     * @return
     */
