...
public class AppEntity implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getAppIconUrl() == null ? other.getAppIconUrl() == null
            : this.getAppIconUrl().equals(other.getAppIconUrl()))
            && (this.getDesignedFor() == null ? other.getDesignedFor() == null
            : this.getDesignedFor().equals(other.getDesignedFor()))
            && (this.getRanking() == null ? other.getRanking() == null : this.getRanking().equals(other.getRanking()))
            && (this.getRatingStr() == null ? other.getRatingStr() == null
            : this.getRatingStr().equals(other.getRatingStr()))
            && (this.getRating() == null ? other.getRating() == null : this.getRating().equals(other.getRating()))
            && (this.getRateAmount() == null ? other.getRateAmount() == null
            : this.getRateAmount().equals(other.getRateAmount()))
            ...
            && (this.getPriceStr() == null ? other.getPriceStr() == null
            : this.getPriceStr().equals(other.getPriceStr()))
            && (this.getPriceStrCn() == null ? other.getPriceStrCn() == null
            : this.getPriceStrCn().equals(other.getPriceStrCn()))
            && (this.getPriceStrUs() == null ? other.getPriceStrUs() == null
            : this.getPriceStrUs().equals(other.getPriceStrUs()))
            && (this.getUsFlag() == null ? other.getUsFlag() == null : this.getUsFlag().equals(other.getUsFlag()))
            && (this.getInPurchaseFlag() == null ? other.getInPurchaseFlag() == null
            : this.getInPurchaseFlag().equals(other.getInPurchaseFlag()))
            && (this.getInPurchaseFreeFlag() == null ? other.getInPurchaseFreeFlag() == null
            : this.getInPurchaseFreeFlag().equals(other.getInPurchaseFreeFlag()))
            ...
            && (this.getDescriptionUs() == null ? other.getDescriptionUs() == null
            : this.getDescriptionUs().equals(other.getDescriptionUs()))
            && (this.getDescriptionCn() == null ? other.getDescriptionCn() == null
            : this.getDescriptionCn().equals(other.getDescriptionCn()))
            && (this.getDescriptionCl() == null ? other.getDescriptionCl() == null
            : this.getDescriptionCl().equals(other.getDescriptionCl()))
            && (this.getDescriptionWc() == null ? other.getDescriptionWc() == null
            : this.getDescriptionWc().equals(other.getDescriptionWc()))
            && (this.getDescriptionGo() == null ? other.getDescriptionGo() == null
            : this.getDescriptionGo().equals(other.getDescriptionGo()))
            && (this.getDescriptionGeek() == null ? other.getDescriptionGeek() == null
            : this.getDescriptionGeek().equals(other.getDescriptionGeek()))
            && (this.getDescriptionMy() == null ? other.getDescriptionMy() == null
            : this.getDescriptionMy().equals(other.getDescriptionMy()))
            && (this.getDescriptionZm() == null ? other.getDescriptionZm() == null
            : this.getDescriptionZm().equals(other.getDescriptionZm()))
            && (this.getSupplier() == null ? other.getSupplier() == null
            : this.getSupplier().equals(other.getSupplier()))
            && (this.getAppSizeStr() == null ? other.getAppSizeStr() == null
            : this.getAppSizeStr().equals(other.getAppSizeStr()))
            ...
            && (this.getCompatibility() == null ? other.getCompatibility() == null
            : this.getCompatibility().equals(other.getCompatibility()))
            && (this.getLanguage() == null ? other.getLanguage() == null
            : this.getLanguage().equals(other.getLanguage()))
            && (this.getAge() == null ? other.getAge() == null : this.getAge().equals(other.getAge()))
            && (this.getCopyright() == null ? other.getCopyright() == null
            : this.getCopyright().equals(other.getCopyright()))
            && (this.getAppInPurchase() == null ? other.getAppInPurchase() == null
            : this.getAppInPurchase().equals(other.getAppInPurchase()))
            && (this.getSnapshotUrl() == null ? other.getSnapshotUrl() == null
            : this.getSnapshotUrl().equals(other.getSnapshotUrl()))
            ...
            && (this.getLastModifiedCode() == null ? other.getLastModifiedCode() == null
            : this.getLastModifiedCode().equals(other.getLastModifiedCode()))
            && (this.getLastModifiedName() == null ? other.getLastModifiedName() == null
            : this.getLastModifiedName().equals(other.getLastModifiedName()))
            && (this.getLastModifiedDate() == null ? other.getLastModifiedDate() == null
            : this.getLastModifiedDate().equals(other.getLastModifiedDate()))
