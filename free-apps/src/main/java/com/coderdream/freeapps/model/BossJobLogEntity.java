...
/**
 * t_boss_job_log
 * @TableName t_boss_job_log
 */
@TableName(value ="t_boss_job_log")
@Data
public class BossJobLogEntity implements Serializable {
    /**
     *
     */
    ...
    public boolean equals(Object that) {
        ...
        BossJobLogEntity other = (BossJobLogEntity) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getJobName() == null ? other.getJobName() == null : this.getJobName().equals(other.getJobName()))
            && (this.getSpiderDate() == null ? other.getSpiderDate() == null : this.getSpiderDate().equals(other.getSpiderDate()))
            && (this.getDistrictFlag() == null ? other.getDistrictFlag() == null : this.getDistrictFlag().equals(other.getDistrictFlag()))
            ...
            && (this.getJobExperienceMax() == null ? other.getJobExperienceMax() == null : this.getJobExperienceMax().equals(other.getJobExperienceMax()))
            ...
            && (this.getBrandScale() == null ? other.getBrandScale() == null : this.getBrandScale().equals(other.getBrandScale()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSpiderDate() == null) ? 0 : getSpiderDate().hashCode());
        result = prime * result + ((getDistrictFlag() == null) ? 0 : getDistrictFlag().hashCode());
        ...
        result = prime * result + ((getJobExperienceMax() == null) ? 0 : getJobExperienceMax().hashCode());
        ...
        result = prime * result + ((getBrandScale() == null) ? 0 : getBrandScale().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", brandScale=").append(brandScale);
