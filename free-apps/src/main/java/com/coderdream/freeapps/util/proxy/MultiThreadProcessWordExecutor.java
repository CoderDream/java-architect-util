 ...
 * @author CoderDream
 */
public class MultiThreadProcessWordExecutor {
    ...
    public void initTestArr() {
        ...
        if (test) {
            ...
            downloadInfoEntityListTemp = HtmlUtil.getDownloadHtmlInfo("pdf", "2022", "08", "09");
        }
...
//                System.out.println("Thread" + getName() + "  " + downloadInfoEntityList.pop());
    ...
    public static void main(String[] args) {
        ...
        MultiThreadProcessWordExecutor test = new MultiThreadProcessWordExecutor();
        test.initTestArr();
