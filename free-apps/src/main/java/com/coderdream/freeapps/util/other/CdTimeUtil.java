...
public class CdTimeUtil {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(CdTimeUtil.class);
     ...
     * @return
     */
    public static Integer timeToSecond(String timeStr) {
        String[] arr;
...
//        m20();
    ...
    public static void m1() {
        ...
        String outputPath = "";
        fileName = MP4_1;
        CdTimeUtil.videoSplit(fileName, "D:/temp/ffmpeg/output2/", 300, true);
    }
