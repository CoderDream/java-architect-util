...
//            }
        ...
        String srcFileNameCn = CommonUtil.getFullPathFileName(folderName, "total_script", ".srt");
        // 写中文翻译文本
        CdFileUtils.writeToFile(srcFileNameCn, newList);
    }
