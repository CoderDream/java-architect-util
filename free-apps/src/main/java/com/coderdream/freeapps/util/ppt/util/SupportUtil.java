...
public class SupportUtil {
    ...
    public static List<Integer> getMaxValueIndexList(List<Map<String, Object>> sourMaps, String keyWord, int num) {
        ...
        return new ArrayList<Integer>(){{ addAll(getIntegerListFromMap(tempMaps, "mapIndex", "0").subList(0, num)); }};
    }
     ...
     * @return
     */
    public static List<Map<String, Object>> getMaxValueList(List<Map<String, Object>> sourMaps, String keyWord, int num) {
     ...
     * @return
     */
    public static List<Map<String, Object>> getMinValueList(List<Map<String, Object>> sourMaps, String keyWord, int num) {
     ...
     * @return
     */
    public static List<Integer> getGtValIndexList(List<Map<String, Object>> sourMaps, String keyWord, String value, Boolean isEqual) {
        // 创建一个临时 maps
        List<Map<String, Object>> tempMaps = getMapsWithIndex(sourMaps, "mapIndex");
     ...
     * @return
     */
    public static List<Map<String, Object>> getGtValList(List<Map<String, Object>> sourMaps, String keyWord, String value, Boolean isEqual) {
     ...
     * @return
     */
    public static List<Integer> getLtValIndexList(List<Map<String, Object>> sourMaps, String keyWord, String value, Boolean isEqual) {
        // 创建一个临时 maps
        List<Map<String, Object>> tempMaps = getMapsWithIndex(sourMaps, "mapIndex");
     ...
     * @return
     */
    public static List<Map<String, Object>> getLtValList(List<Map<String, Object>> sourMaps, String keyWord, String value, Boolean isEqual) {
     ...
     * @return
     */
    public static List<Map<String, Object>> getEqValList(List<Map<String, Object>> sourMaps, String keyWord, String value) {
     ...
     * @return
     */
    public static List<String> getStringListFromMap(List<Map<String, Object>> maps, String keyWord, String defaultValue) {
     ...
     * @return
     */
    public static List<Integer> getIntegerListFromMap(List<Map<String, Object>> maps, String keyWord, String defaultValue) {
    ...
    private static List<Map<String, Object>> getMapsWithIndex(List<Map<String, Object>> maps, String indexKey) {
        // 创建一个临时 maps
        List<Map<String, Object>> tempMaps = new ArrayList<Map<String, Object>>(){{ addAll(maps); }};
