 ...
 * @author CoderDream
 */
public class MultiThreadGetPptExecutor {
    ...
    public class MyThread extends Thread {
        ...
        public void run() {
            ...
            while (!downloadInfoEntityList.isEmpty()) {
                ...
                GenSixMinutePptx.genPpt(folderName, SqliteTitleUtil.processSelect(folderName));
...
//                System.out.println("Thread" + getName() + "  " + downloadInfoEntityList.pop());
    ...
    public static void main(String[] args) {
        ...
        MultiThreadGetPptExecutor test = new MultiThreadGetPptExecutor();
        test.initTestArr();
