...
/**
 * 地理信息-线数据
 * @TableName object_b_linestring
 */
@TableName(value ="object_b_linestring")
@Data
public class ObjectBLinestring implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        ObjectBLinestring other = (ObjectBLinestring) that;
