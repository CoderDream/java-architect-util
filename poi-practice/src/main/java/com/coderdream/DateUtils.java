...
/**
 * @author ：CoderDream
 * @date ：Created in 2021/9/2 17:03
 * @description：
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils
{
     ...
     * 获取一个月的第一天和最后一天
     */
    public static String[] getMonthFirstAndLast()
    {
        //获取前一个月第一天
     ...
     * @return
     */
    public static String getFirstDayOfMonth1(String yearMonth) {
     ...
     * @return
     */
    public static String getLastDayOfMonth1(String yearMonth) {
        String[] yearMonthArr = yearMonth.split("-");
        int year = Integer.parseInt(yearMonthArr[0]);
        int month = Integer.parseInt(yearMonthArr[1]);
...
//        String[] str = getMonthFirstAndLast();
