package com.coderdream.ch03.ch03_02;// 使用链表来建立、删除和打印学生成绩
// ===================================================
...
public class ch03_02 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        String name[] = new String[]{"Allen", "Scott", "Marry", "Jon", "Mark", "Ricky", "Lisa", "Jasica", "Hanson",
            "Amy", "Bob", "Jack"};
        System.out.println(
...
//            findword = Integer.parseInt(buf.readLine());
			findword = random.nextInt(12);
			System.out.print("要删除成绩的学生学号为： " + findword);
			if (findword == -1) {
				break;
			} else {
