...
import com.coderdream.FileUtils;
import java.io.File;
...
//        options.addArguments("--remote-debugging-port=9222");
        ...
        // 配置代理IP
        String proxy = "122.9.183.228\t8000";

        String ipFileName = FileUtils.getResourceRealPath() + File.separatorChar + "ip.txt";
