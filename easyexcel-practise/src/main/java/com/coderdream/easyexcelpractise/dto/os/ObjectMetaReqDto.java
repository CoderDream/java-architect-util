package com.coderdream.easyexcelpractise.dto.os;
...
public class ObjectMetaReqDto implements Serializable {
    ...
    @Size(max = 20, message = "对象名称必须20个字以内。", groups = {AddGroup.class, UpdateGroup.class})
