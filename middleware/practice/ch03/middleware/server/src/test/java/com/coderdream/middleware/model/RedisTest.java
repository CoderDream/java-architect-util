...
//import com.coderdream.middleware.server.entity.User;
...
public class RedisTest {
    ...
    /**
     * 定义 RedisTemplate 操作组件
     * 由于之前已经在 CommonConfig 中已定义注入 RedisTemplate 组件，故而在此可以直接自动配置
     */
    @Autowired
    ...
    /**
     * 采用 StringRedisTemplate 将一字符串信息写入缓存中，并读取出来
     */
    @Test
    public void three() {
