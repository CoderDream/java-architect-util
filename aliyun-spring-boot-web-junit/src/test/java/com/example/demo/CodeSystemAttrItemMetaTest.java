...
@SpringBootTest(classes = {CodeSystemAttrItemMetaTest.class}) //测试的class
@ContextConfiguration(classes = CodeSystemAttrItemMetaTest.class)
public class CodeSystemAttrItemMetaTest {
