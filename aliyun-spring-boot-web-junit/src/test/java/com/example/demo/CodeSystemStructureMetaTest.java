...
@SpringBootTest(classes = {CodeSystemStructureMetaTest.class}) //测试的class
@ContextConfiguration(classes = CodeSystemStructureMetaTest.class)
public class CodeSystemStructureMetaTest {
    ...
    public void testListQuery_01() throws Exception {
        RestTemplate restTemplate = new RestTemplate();
        String uri = URI_PREFIX + BS_PORT + "/api/standardized/object/structure-meta/list";
    ...
    public void testAdd_01() throws Exception {
        RestTemplate restTemplate = new RestTemplate();
        String uri = URI_PREFIX + BS_PORT + "/api/standardized/object/structure-meta/add";
    ...
    public void testAdd_02() throws Exception {
        ...
        // 查
        uri = URI_PREFIX + BS_PORT + "/api/standardized/object/structure-meta/list";
    ...
    public void testCRUD_01() throws Exception {
        ...
        if(resultMap != null) {
            ...
            for (Map<String, Object> recordMap : records) {
                ...
                // 删
                uri = URI_PREFIX + BS_PORT + "/api/standardized/object/structure-meta/delete";
