...
@SpringBootTest(classes = {HistoryDataTest.class}) //测试的class
@ContextConfiguration(classes = HistoryDataTest.class)
public class HistoryDataTest extends BaseTest {

    @Before
    public void init() throws JsonProcessingException {
        super.init();
        URI = URI_PREFIX + OBJECT_DATA_PORT + "/api/object/data/history/data/";
    }
